...
def main():
        ...
        if soup.title.string == "Create new application":
            ...
            app_title = choice(["her", "loc", "tg", "majeste", "telethon", "pyrogram"]) + choice(["user", "bt", "vue", "jsx", "python", "php"]) + choice(["", "_"]) + choice([str(randint(10000, 99999))])
            app_shortname = choice(["her", "loc", "tg", "majeste", "telethon", "pyrogram"]) + choice(["user", "bt", "vue", "jsx", "python", "php"]) + choice(["", "_"]) + choice([str(randint(10000, 99999))])
            AppInfo = {
                "hash": hashh,
                "app_title": app_title,
                ...
                "app_desc": choice(["userbot", "pyrogram", "telethon", "", "web", "cli"])
            }
